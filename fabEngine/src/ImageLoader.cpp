...
GLuint ImageLoader::loadBMP(const char* filepath)
{
	FILE* file;
	if (fopen_s(&file, filepath, "rb") == 0)
	{

		if (!file) { std::cout << "image can't be opened\n"; return 0; }

		if (fread(m_header, 1, 54, file) != 54){
...
GLuint ImageLoader::loadDDS(const char* filepath)
{
